...
```
python -m loaders.mlb_statsapi.schedules                      # current season (default)
python -m loaders.mlb_statsapi.schedules --season 2024
python -m loaders.mlb_statsapi.schedules --start-season 2000 --end-season 2026
python -m loaders.mlb_statsapi.schedules --date 2026-05-08
python -m loaders.mlb_statsapi.schedules --start-date 2026-05-01 --end-date 2026-05-08
python -m loaders.mlb_statsapi.schedules --full-history             # backfill from EARLIEST_SEASON (1876)
python -m loaders.mlb_statsapi.schedules --full-history --full-refresh  # clean full backfill
```
