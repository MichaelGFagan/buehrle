with batting as (
    ...
    select * from {{ source('baseball_reference_dlt', 'war_batting') }}
...
transformed as (
    ...
    select
        ...
        , chadwick.person_id
        , batting.mlb_id::bigint as mlbam_id
        ...
        , batting.team_rp_g::decimal(10,5) as average_team_runs_scored_per_game
        , batting.opp_rp_g::decimal(10,5) as average_team_runs_allowed_per_game
        , batting.opp_rp_pa_rep::decimal(10,5) as average_team_runs_allowed_per_plate_appearance_against_replacement  -- noqa: L016
        , batting.opp_rp_g_rep::decimal(10,5) as average_team_runs_allowed_per_game_against_replacement  -- noqa: L016
