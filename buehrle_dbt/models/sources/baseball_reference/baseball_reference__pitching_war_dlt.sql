with pitching as (
    ...
    select * from {{ source('baseball_reference_dlt', 'war_pitching') }}
...
transformed as (
    ...
    select
      ...
      , chadwick.person_id
      , pitching.mlb_id::bigint as mlbam_id
      ...
      , pitching.i_pouts::bigint as outs_pitched
      , pitching.i_pouts_start::bigint as outs_pitched_as_starter
      , pitching.i_pouts_relief::bigint as outs_pitched_as_reliever
      , pitching.ra::bigint as runs_allowed
      , pitching.x_ra::decimal(7,3) as expected_runs_allowed
      , pitching.x_ra_sprp_adj::decimal(7,3) as expected_runs_allowed_role_adjustment
      , pitching.x_ra_extras_adj::decimal(7,3) as expected_runs_allowed_extra_adjustment
      , pitching.x_ra_def_pitcher::decimal(7,3) as expected_runs_allowed_team_defense_adjustment
      , pitching.ppf::bigint as home_park_factor
      , pitching.ppf_custom::bigint as pitched_park_factor
      , pitching.x_ra_final::decimal(7,3) as expected_runs_allowed_final
      ...
      , pitching.rp_o_replacement::decimal(5,3) as runs_per_out_replacement_level
      ...
      , pitching.team_rp_g::decimal(10,5) as average_team_runs_per_game_with_pitcher
      , pitching.opp_rp_g::decimal(10,5) as average_opponent_runs_per_game
      , pitching.opp_rp_g_rep::decimal(10,5) as average_opponent_runs_allowed_per_game_against_replacement
